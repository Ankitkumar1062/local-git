...
export const COMMAND_HELP: Record<string, CommandHelp> = {
  ...
  release: {
    ...
    options: [
      ...
      { flag: 'view <tag>', description: 'View release details' },
      { flag: 'notes <tag>', description: 'Generate release notes from commits' },
      { flag: 'latest', description: 'Show the latest release' },
      { flag: 'delete <tag>', description: 'Delete a release' },
      { flag: '-t, --title <title>', description: 'Release title' },
      { flag: '-m, --body <text>', description: 'Release notes body' },
      { flag: '-g, --generate', description: 'Generate release notes from commits (AI)' },
      { flag: '-p, --previous <tag>', description: 'Previous tag for comparison' },
      { flag: '-d, --draft', description: 'Create as draft release' },
      { flag: '--prerelease', description: 'Mark as pre-release (e.g., beta, rc)' },
      { flag: '--target <ref>', description: 'Target commit/branch for the tag' },
      { flag: '--style <style>', description: 'Notes style: standard|detailed|minimal|changelog' },
      { flag: '-f, --force', description: 'Overwrite existing release' },
      { flag: '--format <fmt>', description: 'Output format: text|json|markdown' },
      { flag: '--no-stats', description: 'Exclude statistics from notes' },
