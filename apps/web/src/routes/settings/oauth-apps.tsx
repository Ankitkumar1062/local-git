    ...
    <div className="container max-w-[1200px] mx-auto py-8 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Create and manage OAuth applications that integrate with myvcs.
        </p>
      </div>
      ...
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 flex gap-3">
        ...
        <div className="text-sm">
          <p className="font-medium text-blue-500">Build integrations with myvcs</p>
          <p className="text-muted-foreground mt-1">
            OAuth apps allow third-party applications to access the myvcs API on behalf of users.
              ...
              {newApp ? (
                ...
                <form onSubmit={handleCreateApp}>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Create an OAuth application to integrate with the myvcs API.
                    </DialogDescription>
                  </DialogHeader>
        ...
        <CardContent>
          {appsLoading ? (
            ...
            <EmptyState
              icon={AppWindow}
              title="No OAuth Apps"
              description="Register an OAuth app to start building integrations with myvcs."
            />
          ) : (
