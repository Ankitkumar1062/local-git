        ...
        <CardContent className="space-y-6">
          <div className="text-center">
            <p className="text-sm text-muted-foreground">
              <strong className="text-foreground">{app.name}</strong> wants to access your myvcs account
            </p>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs mt-1">
                    This app hasn't been verified by myvcs. Make sure you trust the developer before authorizing.
                  </p>
                </div>
              </div>
            </div>
