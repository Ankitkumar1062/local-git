  ...
  return (
    <div className="container max-w-4xl py-12">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <p>
          By accessing and using myvcs, you accept and agree to be bound by the terms and provision of this agreement.
        </p>

        <h2>2. Use License</h2>
        <p>
          Permission is granted to temporarily download one copy of myvcs for personal, non-commercial transitory viewing only.
          This is the grant of a license, not a transfer of title, and under this license you may not:
        </p>
        <ul>
          <li>Modify or copy the materials</li>
          <li>Use the materials for any commercial purpose or for any public display</li>
          <li>Attempt to reverse engineer any software contained in myvcs</li>
        ...
        <p>
          The Service and its original content, features, and functionality are and will remain the exclusive property of myvcs
        ...
        <p>
          In no event shall myvcs, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any
        ...
        <p>
          ...
          <a href="mailto:legal@myvcs.sh" className="text-primary hover:underline">
            legal@myvcs.sh
          </a>
        </p>
      </div>
